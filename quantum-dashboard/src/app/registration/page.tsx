...
const schema = yup.object().shape({
  ...
  farmer_location: yup.string().required(""),
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <div className="w-full lg:w-1/2 bg-[#F5F5F5] p-4 lg:p-8 flex items-center justify-center">
        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-[640px] 2xl:max-w-[640px] lg:max-w-[500px]">
          <h2 className="text-3xl lg:text-3xl font-bold mb-8 lg:mb-4 text-[#006400] text-center lg:text-left">
            Register a Farmer
          </h2>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full h-12 2xl:h-16 lg:h-12 p-3 border border-black rounded-md text-black ${
          ...
          <div className="flex justify-center">
            <button
              type="submit"
              disabled={isLoading}
              className={`bg-[#E7BB6C] text-[#FFFFFF] mt-8 lg:mt-16 rounded-md hover:bg-[#A0522D] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#8B4513] w-full lg:w-48 h-12 lg:h-[48px] text-lg lg:text-[24px] ${
